...
namespace Kolia.Thumbnail.API.Models.SocialMedias
{
    ...
    /// </summary>
    public class SocialMediaProviderCreateDto : SocialMediaProviderBaseDto
    {
    }
    ...
    /// </summary>
    public class SocialMediaProviderUpdateDto : SocialMediaProviderBaseDto
    {
        /// <summary>
    ...
    /// </summary>
    public class SocialMediaProviderDetailDto : SocialMediaProviderBaseDto
    {
        /// <summary>
    ...
    /// </summary>
    public class SocialMediaProviderBaseDto
    {
        /// <summary>
